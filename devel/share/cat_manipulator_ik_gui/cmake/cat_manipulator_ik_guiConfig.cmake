...
if(NOT "/home/cat/robotnik_arm/src/ROBOTIS-MANIPULATOR/cat_manipulator_ik_gui/include " STREQUAL " ")
  set(cat_manipulator_ik_gui_INCLUDE_DIRS "")
  set(_include_dirs "/home/cat/robotnik_arm/src/ROBOTIS-MANIPULATOR/cat_manipulator_ik_gui/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cat_manipulator_ik_gui' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cat/robotnik_arm/src/ROBOTIS-MANIPULATOR/cat_manipulator_ik_gui/${idir}'.  Ask the maintainer 'thor <cat@gmail.com>' to fix it.")
    endif()
