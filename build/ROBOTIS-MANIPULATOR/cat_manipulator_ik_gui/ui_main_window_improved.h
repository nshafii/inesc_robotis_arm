...
#ifndef UI_MAIN_WINDOW_IMPROVED_H
#define UI_MAIN_WINDOW_IMPROVED_H
...
public:
    ...
    void setupUi(QMainWindow *MainWindowDesign)
    {
        ...
        MainWindowDesign->resize(782, 615);
        QIcon icon;
        ...
        getTagPose_button = new QPushButton(IK);
        getTagPose_button->setObjectName(QString::fromUtf8("getTagPose_button"));

        verticalLayout_10->addWidget(getTagPose_button);
        ...
        publishJointState_button->setFont(font);
    ...
    void retranslateUi(QMainWindow *MainWindowDesign)
    {
        ...
        currentEEFpose->setTitle(QApplication::translate("MainWindowDesign", "End - Effector ", 0, QApplication::UnicodeUTF8));
        getEEF_button->setText(QApplication::translate("MainWindowDesign", "Update EEF Pose", 0, QApplication::UnicodeUTF8));
        ...
        setEEF_button->setText(QApplication::translate("MainWindowDesign", "Get joint values from IK", 0, QApplication::UnicodeUTF8));
        label_2->setText(QApplication::translate("MainWindowDesign", "Apriltags Pose", 0, QApplication::UnicodeUTF8));
        getTagPose_button->setText(QApplication::translate("MainWindowDesign", "Get Apriltags Pose", 0, QApplication::UnicodeUTF8));
        currentJointState_theta->setTitle(QApplication::translate("MainWindowDesign", "Joints", 0, QApplication::UnicodeUTF8));
        getJointState_button->setText(QApplication::translate("MainWindowDesign", "Update Robot Joints", 0, QApplication::UnicodeUTF8));
        FK_joints->setTitle(QApplication::translate("MainWindowDesign", "Joint Values", 0, QApplication::UnicodeUTF8));
        ...
        setJointState_button->setText(QApplication::translate("MainWindowDesign", "Get EEF values from FK", 0, QApplication::UnicodeUTF8));
        label_3->setText(QApplication::translate("MainWindowDesign", "Move Robot : ", 0, QApplication::UnicodeUTF8));
        publishJointState_button->setText(QApplication::translate("MainWindowDesign", "Move Robot", 0, QApplication::UnicodeUTF8));
...
#endif // UI_MAIN_WINDOW_IMPROVED_H
