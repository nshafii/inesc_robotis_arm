#ifndef cat_move_to_target_ROBOT_STATE_H
#define cat_move_to_target_ROBOT_STATE_H
...
#define JOINT1_UPPER_LIMIT M_PI
#define JOINT1_LOWER_LIMIT (-M_PI+0.01)

#define JOINT2_UPPER_LIMIT M_PI/2
#define JOINT2_LOWER_LIMIT 0

#define JOINT3_UPPER_LIMIT M_PI/2
#define JOINT3_LOWER_LIMIT -M_PI/2

#define JOINT4_UPPER_LIMIT M_PI/2
#define JOINT4_LOWER_LIMIT -M_PI/2

#define JOINT5_UPPER_LIMIT M_PI/2
#define JOINT5_LOWER_LIMIT -M_PI/2

#define JOINT6_UPPER_LIMIT M_PI/2
#define JOINT6_LOWER_LIMIT -M_PI/2
...
#endif // cat_move_to_target_ROBOT_STATE_H
