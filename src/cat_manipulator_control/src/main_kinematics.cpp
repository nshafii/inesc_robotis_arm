...
//    ROS_INFO("ori. yaw = %f", yaw_value );
    ...
    std::cout << "ori. x = " << curr_end_effector_Q.x() << std::endl;
    std::cout << "ori. y = " << curr_end_effector_Q.y() << std::endl;
    std::cout << "ori. z = " << curr_end_effector_Q.z() << std::endl;
    std::cout << "ori. w = " << curr_end_effector_Q.w() << std::endl;
